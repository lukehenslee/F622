...
ggsave(file = "Pub_ready_figure_1b_LH.png", width = dev.size()[1], height = dev.size()[2], dpi = 300)
dev.off()
```
...
ggsave(file = "Pub_ready_figure_2_LH.png", width = dev.size()[1], height = dev.size()[2], dpi = 300)
```
